...
description: >-
  团队赋能，将测试经验转化为checklist和模板赋能团队成员。当用户需要培训新人、赋能团队或指导他人时自动触发。
  也适用于：新成员加入需要快速上手，或团队测试能力需要系统性提升时。
   关键词：团队赋能、测试培训、新人指导、经验传递、测试思维培养、技能矩阵、导师制、知识库建设、能力提升。
...
本技能提供四种赋能方式（Checklist/模板/Review/Pair）和培训材料设计方法。
