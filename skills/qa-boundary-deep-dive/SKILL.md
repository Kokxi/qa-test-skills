...
description: >-
  边界深度分析，识别输入、状态、时间、资源四维边界条件。当用户提到边界分析、边界条件、还有什么边界或需要深入分析边界时自动触发。
  也适用于：等价类划分完成后需要补充边界值测试，或面对有明确输入限制的功能时。
   关键词：边界分析、边界条件、等价类、输入验证、边界值、输入边界、状态边界、时间边界、资源边界、边界扫描。
...
**核心原则**：真正的Bug往往在"看起来不是边界"的地方。
本技能从输入、状态、时间、资源四个维度系统识别边界条件。
