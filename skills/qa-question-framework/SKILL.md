...
description: >-
  提问框架，提供不同场景下获取关键信息的提问模板。当用户不知道该问什么问题、需要获取信息或需求不清楚需要澄清时自动触发。
  也适用于：与产品经理或开发沟通需求细节，或需求文档信息不足需要补充时。
   关键词：提问框架、信息获取、需求澄清、沟通模板、5W1H质疑、逆向提问、追问技巧、提问链、评审提问、Bug报告提问、复盘提问。
...
**核心原则**：专家不是"知道答案"，而是"知道该问什么"。
本技能覆盖四大提问场景（需求/评审/报Bug/复盘）和三种提问技巧。
