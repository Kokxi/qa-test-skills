...
description: 高级测试用例设计专项，专注测试用例结构、分类、覆盖策略，不生成测试步骤。当需要设计测试用例、评审用例质量、优化用例覆盖时激活。
when_to_use: 用户说"设计测试用例"、"用例评审"、"用例覆盖"、"测试用例设计"、需要测试用例结构指导时
...
- **依据**：测试用例应该验证"系统应该做什么"，而不是"系统如何实现"
