...
> **45个专家级测试技能，覆盖测试全生命周期** | 让初级测试人员输出专家级测试用例 | AI辅助测试设计最佳实践

![Version](https://img.shields.io/badge/version-1.3.0-blue)
![License](https://img.shields.io/badge/license-MIT-green)
![Skills](https://img.shields.io/badge/skills-45-orange)
...
**QA Test Skills** 是一个专为软件测试人员设计的AI技能集，包含45个专家级测试技能，覆盖从需求分析到测试设计、AI协作、执行监控、质量度量的完整测试生命周期。
